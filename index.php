...
?>
                ...
                <br>
                <font color="red" size="5">Fundamental Gun Safety Rules</font> </center>
              Conscientious attention to these rules will prevent most, if not
              all, gun accidents. Be aware that ignorance and carelessness lead
              ...
              destroy any valuable property. Careful attention to muzzle
              direction is key to safely handling a firearm. When carrying a
              firearm from place to place, the best way to control the muzzle is
              to keep it in your view. Be aware of what objects can stop a
              bullet, and what ones cannot. In NRA courses, and on shooting
              ranges, the instructor or range officer will explain and point out
              the safe directions available. <br>
              <br clear="all">
              <img src="/media/rule2.png" align="left"><strong><font size="+2">2.
                  Always
                  keep your finger off the trigger until ready to shoot</font></strong>
              <br>
              Under normal conditions guns do not discharge unless the trigger
              is pulled. When holding or manipulating a gun, hold the grip
              ...
              loaded, but such firearms must always be under your control. Guns
              not in use, but not stored, should have the action locked open so
              that anyone may inspect the chamber and magazine for live
              ammunition. When handing a gun to another person, lock open the
